 ...
 *
 * Runs at the start of each user turn for Claude Code and Codex CLI. Saves a
 * baseline SHA representing the working tree state at this moment so that
 * `stop_review.ts` can compute "this turn's changes".
 *
 * Strategy:
