...
- 質問を始める前に、「この依頼で気づかれていない未知の未知・見落とし」を先に列挙する（前提の誤り、考慮されていない利用者やエッジケース、依頼文に現れていない設計判断など）
- ユーザーもClaudeもまだ疑問として認識していないものを表に出すのが目的。Claudeが疑問に思ったことを聞くのは次のステップ
- 列挙した盲点は決定ツリーに枝として組み込み、以降の質問で潰す
